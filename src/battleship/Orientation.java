...
/**
 * The orientation of a ship. The names of the enum values
 * were chosen because they are descriptive and match the
 * words put in the configuration files.
 */
public enum Orientation {
     HORIZONTAL(0, 1), VERTICAL(1, 0);

    /**
     * Use it to loop through all the cell locations a ship
